        ...
        <div class=" custome-row">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="title animated wow fadeInLeft" data-wow-delay="0.5s" data-wow-duration="1s"><span
                            ...
                            <p>Character</p>
                            <h1>Values and Morals </h1> <span class="right line">
                ...
                <div class="row bg_section2">
                    ...
                    <div class="col-md-6">
                        <div class="sek-container">
                            <h3>Perfect balance in satisfying body and soul needs </h3>
                            <p>
                              Muhammad called for maintaining the right balance between materialism and spiritualism. He taught his followers that the needs of body and soul must be satisfied but in the right balance and in lawful ways. He encouraged people to take religion as a motivator for a better way of life which adds value to their bodies and souls.
            ...
            <section class="pad-tb-50">
                <div class="row bg_section2">
                    ...
                    <div class="col-md-6">
                        <div class="sek-container">
                            <h3>Muhammad condemned extremism: </h3>
                            <p>
                                called for a balanced way of life, balanced views and rational thinking. It is narrated that three people came to his house to ask about his style of worship. Muhammad wasn’t at home and his wife talked to them. However, they found his level of worship less than what they expected. They thought that a religious way of life requires focusing on spiritualities  and ignoring some of the body needs or depriving it from natural desires.
                            </p>
                        </div>
                    </div>
                </div>
...
When Muhammad knew what they said, he was upset but he stated that he usually performed extra prayers at night and rested like other people. In addition to the annual fasting in the month of Ramadan, he fasted for some time and he did not fast for other times. Finally, he got married and did not like people to stay single. He said:
            ...
            <section class="pad-tb-50">
                <div class="row bg_section2">
                    ...
                    <div class="col-md-6">
                        <div class="sek-container">
                            <h3>Muhammad does not like difficulty: </h3>
                            <p>
It is narrated that whenever Muhammad had to decide on a matter or an issue where more than one option or alternative was given, he always avoided hardship and chose the least complicated one provided that it  fulfilled the required goals and did not involve unlawful acts. (Sahih Al-Bukhari, 8/160, 6786. Sahih Muslim, 7/80, 2327)
            ...
            <section class="pad-tb-50">
                <div class="row bg_section2">
                    ...
                    <div class="col-md-6">
                        <div class="sek-container">
                            <h3>Purification and cleanliness </h3>
                            <p>
...
"And your clothing purify.”
      <span class="refs">The Quran, 74:4  </span>
                            </span>
...
Performing ablution before praying is an essential requirement for prayers. It includes washing the hands, face, forearms up to the elbows, wiping the head and washing the feet.
            ...
            <section class="pad-tb-50">
                <div class="row bg_section2">
                    ...
                    <div class="col-md-6">
                        <div class="sek-container">
                            <h3>Ghusul, complete body wash  </h3>
                            <p>
...
Muhammad emphasized cleanliness and purification in all aspects of life. He asked his companions to clean their homes  and surroundings regularly. He taught them that removing harm or garbage from the road is a rewardable charity act.
                        ...
                        <div class="sek-container">
                          ...
                          <div class="note animate showFromLeft" data-animate="showFromRight" data-delay="3.3" style=" ">
                              ...
                              <div class="off">
                                  <div>
                                      <div contenteditable="true" spellcheck="false">
                                        • Dress in clean and tidy clothes but do not be prodigal <br> • Use perfumes (Teeb) to smell good <br> • Trim your nails, remove pubic and armpit hair <br> • Wash hands before and after eating. Do not touch food after waking up until hands are washed.
                                      </div>
                                  </div>
                              </div>
                          </div>
            ...
            <section class="pad-tb-50">
                <div class="row bg_section2">
                    ...
                    <div class="col-md-6">
                        <div class="sek-container">
                            <h3>Miswak and dental care. Clean mouth and good breath during the whole day </h3>
                            <p>
                            Performing “Ghusul” (washing the whole body) on a regular basis is strongly recommended and is considered as part of Muhammad’s Sunnah (teachings and way of life). However, Ghusul is a must for purity on certain occasions (e.g. after marital contact and menstruation).
                            </p>
                ...
                <div class="row bg_section2">
                    ...
                    <div class="col-md-6">
                        <div class="sek-container">
                          ...
                          <span style="line-height:20px; color:#fff;" class="hadith ver-2 verse animate showFromLeft showFromRight" data-animate="showFromRight" data-delay="3.3" style="visibility: visible;">
Indeed, in the creation of the heavens and the earth and in the alteration of the night and the daylight are signs (of God’s creative power) for those of understanding and discretion. The ones who remember Allah (the Lord of all beings) with reverence while standing and while sitting and while lying on their sides. And who reflect on the creation of the heavens and the earth, and say: Our Lord! You have not created all this in vain, exalted are You, then protect us from the punishment of the Fire.
                            <span class="refs"> The Quran, 3:190-191  </span>
                          </span>
...
And in the earth, there are wondrous (incredible) signs (indicating the presence of God) and in yourselves (there are similar signs), can you not then see?
                            <span class="refs"> The Quran, 51:20-21 </span>
                          </span>
                ...
                <div class="row bg_section2">
                    ...
                    <div class="col-md-6">
                        <div class="sek-container">
                          ...
                          <table style="width:600px; margin:34px auto;" class="table merciful animate showFromDown" data-animate="showFromDown"
                                 data-delay="3.3">
                        ...
                        <div class="sek-container">
                          ...
                          <table style="width:600px; " class="table merciful animate showFromDown" data-animate="showFromDown"
                            ...
                            <tbody>
                              ...
                              <tr>
                                 <td style="color:#fff;">Algoritmi Father of Algorithms <font color="#bf3d32">780-850 CE </font></td>
                                <td style="color:#fff;">
                                  <b> Mohammad Ibn Musa Al-Khwarizmi </b>was one of the greatest scientists of his time. He was a mathematician, an astronomer and a geographer. He introduced the decimal positional number system to the world. He made a great contribution to Mathematics when he developed Algebra (derived from the word Al-Jabr) and “algorithms” which were named after him. His name is the origin of the word guarismo in Spanish and the word algarismo in Portuguese, both meaning digit.
                        ...
                        <div class="sek-container">
                          ...
                          <table style="width:600px; margin:34px auto;" class="table merciful animate showFromDown" data-animate="showFromDown"
                            ...
                            <tbody>
                              ...
                              <tr>
                                 <td style="color:#fff;">Rhases (Rasis) Father of Physicians <font color="#bf3d32">865-929 CE </font></td>
                                <td style="color:#fff;">

                              <b>Abu Bakr Muhammad Ibn Zakariya AlRazi.</b> He was considered by many scientists as the father of physicians. He was the first to differentiate smallpox from measles. He discovered numerous compounds and chemicals including alcohol and kerosene. Edward Granville Browne considers him as the most original of all the physicians. He wrote many important books which were translated to different languages including English such as “Al-Hawi” medical Encyclopedia, The Big Pharmacology, Kidney and Bladder Stones and  The Book of Experiences.
                        ...
                        <section class="pad-tb-50">
                            <div class="row bg_section2">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <h3> Personal development through sport  </h3>

                                  <p> Muhammad used to encourage his companions to maintain healthy bodies and learn different types of sports such as swimming, archery, horse riding and horse racing (horsemanship).  </p>
                                  <p>In addition, he participated in several running competitions with his companions, a sport that brings happiness and excitement. It is narrated that Muhammad used to do running races with his wife Aisha. She won the race once and he won the race on another occasion.  This activity reflected the mutual love, harmony and fun Muhammad  had with his wife.  </p>
                                  <p> Muhammad allocated an area to be a racing field in the western side of the Nabawi Mosque in Madinah. Horse racing used to be conducted in the same field as well. A mosque was built next to the racing field and it was called the Sabaq Mosque (i.e. the mosque of the racing field).
 </p>
