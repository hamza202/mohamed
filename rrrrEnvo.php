...
<div class="forimgshadowLeftrr animated wow fadeInLeftBig" data-wow-delay="0.4s" data-wow-duration="2s">
    <img src="img/ural/animale8.jpg" class="forImgEnvorr animated wow fadeInLeftBig" data-wow-delay="1.2s" data-wow-duration="2s" />
    </div>
</div>
...
<div class="col-sm-7 text-left animated wow fadeInUpBig forseven" data-wow-delay="1.4s" data-wow-duration="2s" style="padding:0 100px;z-index:-1;">
<h2 class="h2 weDoing">
...
<p class="forprography forAya animated wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="2s">“O mankind!
The bowing tree was found in a
camping site in Nowra, South of
Sydney, Australia. It resembles bowing
to God in the Muslims' prayers. The
lower edge of the tree looks like the
head of a bowing person.
<!-- <span class="forNumberAya"><br>The Quran, 49:13<br>
The Inner Apartments (Al-Hujurát)</span> -->
</p>

<p class="doingP text-justify">
He linked the preservation of the environment to the belief
in one God, Who created all beings. Therefore, a believer in
God cannot cause mischief to the environment because it
...
<p class="forprography forAya animated wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="2s">“O mankind!
“Any Muslim who plants a
seed that grows to a level,
people or animals or birds
can benefit or eat from it,
then this act is considered
as a Sadaqa”
(a charity that is rewarded by
God).
...
<div class="container-fluid">
    <div class="row text-center rowNqsh">
<div class="col-sm-7 forseven2 text-left nqsh nqshRight animated wow fadeInUpBig" data-wow-delay="1.4s" data-wow-duration="2s" style="">
...
were created by God and were set by Him in perfect
equilibrium. 
</p>
<p class="forprography forAya animated wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="2s">“O mankind!
“Verily all things We created are in proportion and measure.”
“... and everything with Him is in due proportion (measured).”
...
<div class="forimgshadowRightrr2 animated wow fadeInRightBig" data-wow-delay="0.4s" data-wow-duration="2s" >
    <img src="img/ural/animale1.jpg" class="forImgEnvorr2 animated wow fadeInRightBig" data-wow-delay="1.2s" data-wow-duration="2s"  />
    </div>
</div>
    </div>
</div>
...
<div class="col-sm-5 forfive" style="padding:0;">
<div class="forimgshadowLeftrr animated wow fadeInLeftBig" data-wow-delay="0.4s" data-wow-duration="2s">
    <img src="img/ural/animale9.jpg" class="forImgEnvorr animated wow fadeInLeftBig" data-wow-delay="1.2s" data-wow-duration="2s" />
    </div>
</div>
...
<p class="forprography animated wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="2s">“O mankind!
...
<div class="col-sm-5 forfive2" style="padding:0;">
<div class="forimgshadowRightrr2 animated wow fadeInRightBig" data-wow-delay="0.4s" data-wow-duration="2s" >
    <img src="img/ural/m1.jpg" class="forImgEnvorr2 animated wow fadeInRightBig" data-wow-delay="1.2s" data-wow-duration="2s"  />
    </div>
</div>
    </div>
</div>
